		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SD] 문의서 조회",
									"targetURL": "#syncdcsdproject11-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncdcsdproject11-display": {
								"semanticObject": "syncdcsdproject11",
								"action": "display",
								"description": "[SD] 문의서 조회",
								"title": "[SD] 문의서 조회",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.dc.sd.project11",
									"url": sap.ui.require.toUrl("sync/dc/sd/project11")
								}
							}
						}
					}
