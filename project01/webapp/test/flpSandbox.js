		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SD] 문의서 등록",
									"targetURL": "#syncdcsdproject01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncdcsdproject01-display": {
								"semanticObject": "syncdcsdproject01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.dc.sd.project01",
									"url": sap.ui.require.toUrl("sync/dc/sd/project01")
								}
							}
						}
					}
